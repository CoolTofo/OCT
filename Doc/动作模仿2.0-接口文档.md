...
|**参数** |**类型** |**可选/必选** |**说明** | |
|---|---|---|---|---|
|aigc_meta |AIGCMeta |可选 |隐式标识 |隐式标识验证方式：<br><br><br>可在[人工智能生成合成内容标识服务平台](https://www.gcmark.com/web/index.html#/mark/check/video)进行验证，步骤为：访问平台并注册帐号 \-\> 上传打标后的视频 \-\> 点击开始检测 \-\> 输出检测结果如下图即代表成功<span>![图片](https://portal.volccdn.com/obj/volcfe/cloud-universal-doc/upload_37d8115b3de900fec9b697787ea51d86.png) </span> |
